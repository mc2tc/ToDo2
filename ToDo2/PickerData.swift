...
class PickerData: NSObject {
    ...
    static var categoryDict: [String:Int] = ["Personal":11,"Strategic":10,"Stakeholder":9, "Talent":8, "Problem/Market":7, "Solution/Product":6, "Partnerships":5, "Finance":4, "Legal and Admin":3]
